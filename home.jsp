...
<body>
	...
	<div class="content_box">
		<div class="mix">
           <img id="flower" src="<%=request.getContextPath()%>/asset/IMG/index/mixed.webp" alt=" " width="300px" height="300px" >
            <h2>Anniversary Bouquet</h2>
          </div>  
          <div class="mix">
           <img id="flower" src="<%=request.getContextPath()%>\asset\IMG\index\cake with flower.jpeg" alt=""  width="300px" height="300px">
            <h2>Birthday Cake With<br> Bouquet</h2>
       </div>
       <div class="mix">
            <img  id="flower" src="<%=request.getContextPath()%>\asset\IMG\index\red.jpg" alt=""  width="300px" height="300px">
            <h2>Red Rose Bouquet</h2>
       
        </div>
        <div class="mix">
            <img  id="flower"src="<%=request.getContextPath()%>\asset\IMG\index\blackforest.webp" alt="" width="300px" height="300px">
            <h2>Anniversary Bouquet With<br>cake</h2>
        </div>
    
     <div class="mix">
            <img  id="flower" src="<%=request.getContextPath()%>\asset\IMG\index\yellow.jpg" alt="" width="300px" height="300px">
            <h2>Yellow Bouquet</h2>
       </div>
       <div class="mix">
              <img  id="flower" src="<%=request.getContextPath()%>\asset\IMG\index\birthday.jpg" alt="" width="300px" height="300px">
            <h2>Birthday Bouquet</h2>
       </div>
       <div class="mix">
            <img  id="flower" src="<%=request.getContextPath()%>\asset\IMG\index\pink.jpg" alt="" width="300px" height="300px">
            <h2>Pink Bouquet</h2> 
           </div>
      <div class="mix">
           <img  id="flower" src="<%=request.getContextPath()%>\asset\IMG\index\white.jpg" alt="" width="300px" height="300px">
		...
		<footer>
			<div class="icon">
				...
				<h4>
					Feel Free to follow Us on our social<br> media handless all
					the links are<br> given below.
				</h4>
